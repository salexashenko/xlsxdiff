...
Current coverage includes simple assumption impacts, named-range rebinding, large-range membership, inserted modeling steps, manual calculation mode, unchanged formula caches, structured table references, external references, hidden-sheet drivers, multiple upstream roots, formula-to-hardcode overrides, and compacted intermediate formula chains.
